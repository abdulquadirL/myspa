    ...
    <div className="bg-cream p-6 rounded-lg shadow-md max-w-4xl mx-auto mt-8">
        ...
        <section id="massage" className="py-8">
          <Card className="p-6 text-center bg-amber-50 dark:bg-gray-800">
            ...
            < Image src="/nirvana/massage.jpeg" alt="Massage Therapy" className="w-full h-100 object-cover rounded-lg mt-4" />
          </Card>
        </section>
        <section id="massage" className="py-8">
          <Card className="p-6 text-center bg-amber-50 dark:bg-gray-800">
            ...
            < Image src="/nirvana/salon.jpg" alt="Unisex Salon" className="w-full h-100 object-cover rounded-lg mt-4" />
          </Card>
        </section>
        <section id="nail" className="py-8">
          <Card className="p-6 text-center bg-amber-50 dark:bg-gray-800">
            ...
            < Image src="/nirvana/nails.jpg" alt="Nail Services" className="w-full h-100 object-cover rounded-lg mt-4" />
          </Card>
        </section>
        <section id="facials" className="py-8">
          <Card className="p-6 text-center bg-amber-50 dark:bg-gray-800">
            ...
            <Image src="/nirvana/facials.jpg" alt="Facial Treatments" className="w-full h-100 object-cover rounded-lg mt-4" />
          </Card>
        </section>
        <section id="lash"  className="py-8">
          <Card className="p-6 text-center bg-amber-50 dark:bg-gray-800">
            ...
            < Image src="/nirvana/lash.jpg" alt="Lash Services" className="w-full h-100 object-cover rounded-lg mt-4" />
          </Card>
        </section>
        <section id="manicure" className="py-8 ">
          <Card className="p-6 text-center bg-amber-50 dark:bg-gray-800">
            ...
            < Image src="/nirvana/pedicure.jpg" alt="Manicure & Pedicure" className="w-full h-100 object-cover rounded-lg mt-4" />
          </Card>
        </section>
    </div>
  );
